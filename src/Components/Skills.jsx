...
const Skills = () => {
  ...
  return (
    <div data-aos="" id="Skills" className="p-20 flex flex-col items-center justify-center">
      ...
      <div className="grid lg:grid-cols-5 md-grid-cols-2 grid-cols-1 justify-around gap-14">
