    ...
    <div id="Education" className="lg:px-56 md:px-20 px-5 lg:py-24">
          ...
          <div className="flex mt-8 gap-2">
              <div className="flex items-center justify-center">
                  <div data-aos="fade-left" className="flex space-x-2">
                    <a class="urllink"  href="https://drive.google.com/file/d/1W4l0GwKWFtBtS3P4HT9ZAqzg5aLK1fDp/view?usp=sharing">
      ...
      <div className="lg:py-0 py-10 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-16 items-center">
        <div className="h-full lg:py-10 flex flex-col justify-center lg:items-start items-center text-white">
          ...
          <p data-aos="fade-right" className="text-green-200 text-[18px]">In response to the prevalent financial challenges prompting individuals to resort to high-interest loans, the concept of a family/apartment complexes savings fund has emerged as a viable alternative. However, the management and accounting complexities associated with such funds have proven arduous and time-consuming, necessitating the involvement of professional accountants. To address these challenges, <b className="text-green-700"> I developed a web application that automates savings fund operations, streamlining financial transactions, eliminating the need for experts, and fostering a user-friendly environment.</b><br/>The solution incorporates an innovative approach to address common financial issues, offering a distinct structure from existing software, tailored for widespread public use. <b className="text-green-700">The project involved a thorough analysis of market competitors, identifying weaknesses to inform the design of a web-based software system with separate interfaces for administrators and members.</b><br/>The administrator interface facilitates swift fund management decisions, providing a straightforward view of fund account information. The members' interface allows easy account management, ensuring flexibility aligned with fund manager decisions. The implementation leverages the React.js framework for the user interface and the Go language for the server. <b className="text-green-700">Rigorous testing, utilizing the Go language internal test framework, covers over 81% of the program, ensuring quality and correct performance in all scenarios.</b> This comprehensive solution aims to enhance financial management accessibility and efficiency across diverse segments of society.</p>
