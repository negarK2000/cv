  ...
  return (
    <div id="About" className="lg:px-56 md:px-20 px-5 lg:py-0 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col-reverse justify-between lg:gap-16 items-center">
      <div className="h-full lg:py-40 flex flex-col justify-center lg:items-start items-center text-white">
        ...
        <p data-aos="fade-left" className="text-blue-200 text-[18px]">I'm a passionate full-stack and software developer with a love for creating and bringing ideas to life through code. Programming gives me the power to build worlds and turn my imagination into reality. I thrive on the constant learning and challenges that come with this dynamic field. I believe in writing clean, maintainable code and enjoy finding elegant solutions to intricate problems. I'm excited to embark on new opportunities, tackle new projects, and contribute to the ever-evolving tech landscape.</p>
